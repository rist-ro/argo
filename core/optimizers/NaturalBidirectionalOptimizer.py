...
from core.optimizers.NaturalReweightedWakeSleepOptimizerAlternate import NaturalReweightedWakeSleepOptimizerAlternate


class NaturalBidirectionalOptimizer(NaturalReweightedWakeSleepOptimizerAlternate):
