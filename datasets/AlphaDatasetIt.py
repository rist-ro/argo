...
from word_embedding.test.core.load_embeddings import load_embeddings_ldv_hdf, load_dict, load_emb_base, \
    get_alpha_ldv_name
...
#TODO need to extract abstract class managing tfds iterator. Ask me if you need (Riccardo)
