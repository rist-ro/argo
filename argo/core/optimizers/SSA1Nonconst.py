...
I have implemented the SSA 1 algorithms, given in:
...
The Default values for the 3 hyper-parameters: 'lr', and 'k'.
1.) 'k = 2.0'
2.) 'lr = 1e-2'
...
# The subclass of Optimizer class, containing the SSA 1 splitting-type method with non-constant momentum coefficient
class SSA1Nonconst(optimizer.Optimizer):
    # The constructor of the class
    def __init__(self, model, learning_rate = 1e-2, k = 2.0, alpha = 4.0, use_locking = False, name = 'SSA1Nonconst'):
    ...
    # The actual SSA 1 implementation for the general case when we have dense 'Tensor' objects
